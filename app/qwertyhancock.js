...
(function () {
    ...
    var init = function (us) {
        ...
        settings = {
            ...
            activeColour:   user_settings.activeColour || 'grey',
            borderColour:   user_settings.borderColour || '#000',
            keyboardLayout: user_settings.keyboardLayout || 'de'
        };
    ...
    var styleWhiteKey = function (key) {
        ...
        key.el.style.border = '1.5px solid ' + settings.borderColour;
